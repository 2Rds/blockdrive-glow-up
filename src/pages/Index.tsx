      ...
      <section id="features" className="py-20 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <FeatureCard icon={Wallet} title="Embedded Wallet Authentication" description="Connect securely with your Solana wallet. Your keys, your data, your control." delay={100} />
